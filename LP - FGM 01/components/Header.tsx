...
const Header: React.FC = () => {
  ...
  // Filtered links to ensure they point to existing sections
  const navLinks = [
  ...
  const handleLinkClick = (e: React.MouseEvent<HTMLAnchorElement>, href: string) => {
    // We let the browser handle the smooth scroll via the href anchors
    // as we've defined 'scroll-smooth' and 'scroll-padding-top' in index.html.
    setIsOpen(false);
  };
